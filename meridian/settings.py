...
STRIPE_PRICE_MESSAGE_CREDITS = os.getenv("STRIPE_PRICE_MESSAGE_CREDITS")
STRIPE_PRICE_METERED = os.getenv("STRIPE_PRICE_METERED")
...
if DEBUG:
    # Local development should stay on plain HTTP.
